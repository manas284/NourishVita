    ...
    <div className="bg-background">
        ...
        <section className="container py-12 md:py-16">
             <div className="flex flex-col lg:flex-row gap-12">
                 {/* Main Content Area */}
                 <article className="lg:w-2/3 prose lg:prose-lg max-w-none dark:prose-invert">
                    ...
                    <div>
                        <h3 className="text-xl font-semibold mb-4 border-b pb-2">Featured Products</h3>
                         <div className="space-y-4">
                            ...
                            <Link href="/shop/organic-chia-seeds" className="flex items-center gap-4 p-3 rounded-lg hover:bg-secondary/10 transition-colors border">
